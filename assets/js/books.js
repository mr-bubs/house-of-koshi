const KOSHI_BOOKS = {
  "polynomials": {
    title: "Polynomials",
    slug: "polynomials",
    folder: "Polynomials/pages",
    complete: false,
    type: "Original",
    productionUrl: "../studios/polynomials/",
    chapters: [
      { label: "Chapter 1", startPage: 2 },
      { label: "Chapter 2", startPage: 13 },
    ],
  },
  ...
  "the-assigned": {
    ...
    complete: false,
    type: "Original",
    productionUrl: "../studios/assigned/",
    chapters: [
      { label: "Chapter 1", startPage: 1 },
    ],
  },

  "art-of-love-and-destruction": {
    title: "The Art of Love and Destruction",
    slug: "art-of-love-and-destruction",
    folder: "art-of-love/pages",
    complete: true,
    type: "Creative Adaptation",
    productionUrl: "../studios/art-of-love/",
    credit: {
  ...
  "fallen": {
    ...
    chapters: [
      { label: "Chapter 1", startPage: 2 },
      { label: "Chapter 2", startPage: 10 },
      { label: "Chapter 3", startPage: 19 },
